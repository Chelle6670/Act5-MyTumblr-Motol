...
<head>
    ...
    .cover {
        background-image: url('images/best-background.jpg');
            ...
            <div class="bg-white shadow rounded overflow-hidden">
                <div class="px-4 pt-0 pb-4 cover">
                    <div class="media align-items-end profile-head">
                        <div class="profile mr-3"><img src="images\Rochelle.jpg" alt="..." width="150"
                ...
                <div class="bg-light p-4 d-flex justify-content-end text-center">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
                            <h5 class="font-weight-bold mb-0 d-block">28,579</h5><small class="text-muted"> <i
                                    class="fas fa-image mr-1"></i>Photos</small>
                        </li>
                        <li class="list-inline-item">
                            <h5 class="font-weight-bold mb-0 d-block">2,876,159</h5><small class="text-muted"> <i
                                    class="fas fa-user mr-1"></i>Followers</small>
                        </li>
                        <li class="list-inline-item">
                            <h5 class="font-weight-bold mb-0 d-block">3499</h5><small class="text-muted"> <i
                ...
                <div class="px-4 py-3">
                    ...
                    <div class="p-4 rounded shadow-sm bg-light">
                        ...
                        <p class="font-italic mb-0">Editing</p>
                ...
                <div class="py-4 px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class="mb-0">Recent Captures</h5><a href="#" class="btn btn-link text-muted">Show
                            all</a>
                    </div>
                    <div class="row">

                        <div class="col-lg-6 mb-2 pr-lg-1"><img
                                src="images\bless.jpg" alt=""
                        ...
                        <div class="col-lg-6 pr-lg-1 mb-2"><img
                                src="images\laylay.jpg" alt=""
                                class="img-fluid rounded shadow-sm"></div>
                        <div class="col-lg-6 pl-lg-1"><img
                                src="images\rockformation.jpg" alt=""
                                class="img-fluid rounded shadow-sm"></div>
                    </div>
                </div>
