...
$acc_username = "Rochelle";
$acc_password = "password123";
$acc_fullname = "Rochelle Motol";
...
if (isset($_REQUEST['login_button']) === true) {
    ...
    if (isset($_REQUEST['form_username']) != $acc_username) {
        header("Location: ".$url_add."?notexist");
    }
    else if (isset($_REQUEST['form_username']) == $acc_username && $_REQUEST['form_password'] != $acc_password) {
                        ...
                        <form method="POST" class="login-form">
                            ...
                            <div class="form-group">
                               ...
                               if (isset($_REQUEST['notexist']) === true) {
                                    ...
                                    echo "<div class='alert alert-success' role='alert'> Redireting...</div>";
